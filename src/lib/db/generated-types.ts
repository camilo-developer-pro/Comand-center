...
export type BlockType = "code" | "divider" | "heading" | "image" | "page" | "quote" | "table" | "task" | "text";
...
export interface AsyncProcessingErrors {
  block_id: string;
  created_at: Generated<Timestamp | null>;
...
export interface BlockProcessingQueue {
  block_created_at: Timestamp | null;
  block_id: string | null;
  block_updated_at: Timestamp | null;
  ...
  seconds_since_update: Numeric | null;
  type: string | null;
  unresolved_error_count: Int8 | null;
...
export interface EmbeddingHealth {
  coverage_percent: Numeric | null;
  embedded_blocks: Int8 | null;
  last_embedding_update: Timestamp | null;
  pending_blocks: Int8 | null;
  stale_blocks: Int8 | null;
  total_blocks: Int8 | null;
  workspace_id: string | null;
...
export interface DB {
  ...
  async_processing_errors: AsyncProcessingErrors;
  ...
  block_processing_queue: BlockProcessingQueue;
  blocks: Blocks;
  blocks_v3: BlocksV3;
  crm_leads: CrmLeads;
  "cron.job": CronJob;
